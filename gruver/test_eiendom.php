...
<head>
    ...
    <style>
        ...
        @media (max-width: 1024px) {
            ...
            #mobile-toggle {
                top: 82px !important;
                /* Meny-knappen flyttes litt ned på mobil */
            }
        ...
        .point-popup .leaflet-popup-content {
            ...
            /* God plass til den røde lukk-knappen øverst */
            margin-right: 15px !important;
            /* Flytt scrollbar helt til høyre */
            line-height: 1.5;
        }
        ...
        .inverted-layer {
            ...
            /* TEST MODE: Forenklet filter uten heavy drop-shadow */
        ...
        @media (max-width: 1024px) {
            #coord-search-container {
                width: calc(100% - 40px);
                top: 70px;
                /* Below the toggle sidebar on mobile maybe? */
            }
...
<body>
    ...
    <div id="app-container">
        ...
        <div id="map">
            ...
            <button id="finish-tool-btn">✅ Fullfør og beregn</button>
    ...
    <script>
        ...
        // iOS Detection for "Add to Home Screen" tooltip (Optional enhancement)
        const isIos = () => {
        ...
        if (isIos() && !isInStandaloneMode()) {
            // Here you could show a toast message explaining how to add to home screen on iOS
            // e.g. "Trykk på Del-knappen og velg 'Legg til på Hjem-skjerm' for å installere appen."
            console.log("iOS detected - Show Add to Home Screen instructions if desired.");
        }
    </script>
</body>
