document.addEventListener('DOMContentLoaded', async () => {
  ...
  const TRANSLATIONS = {
    no: {
      ...
      step1Desc: "Gå til Smartbok, Unibok, Pendel, Brettboka, Kindle eller dokumentet du vil skanne i Chrome.",
      ...
      secPlatforms: "📚 Støttede Plattformer",
      platSmartbok: "2-siders oppslag støttes med automatisk beskjæring av nettlesermarger, kapittelgjenkjenning og isolerte tekstspalter.",
      platUnibok: "Vertikal rulling med sømløs overlapping og matematisk piksel-søm.",
      platPendel: "Gyldendals nye læringsplattformer gjenkjennes automatisk med optimal vertikal rulling.",
      platBrettboka: "Automatisk blaing og tilpasset side-ramme for e-bøker på Brettboka.",
      platKindle: "Støtter automatisk blaing i Kindle Cloud Reader (read.amazon.com).",
    ...
    en: {
      ...
      step1Desc: "Navigate to Smartbok, Unibok, Pendel, Brettboka, Kindle, or the online document in Chrome.",
      ...
      secPlatforms: "📚 Supported Platforms",
      platSmartbok: "2-page spreads supported with automatic margin trimming, chapter boundary detection, and column-isolated searchable text.",
      platUnibok: "Vertical scrolling with seamless overlap alignment and pixel-perfect stitching.",
      platPendel: "Gyldendal's new learning platform detected automatically with optimized vertical scrolling.",
      platBrettboka: "Automatic flipping and tailored page framing for Brettboka e-books.",
      platKindle: "Supports automatic flipping in Kindle Cloud Reader (read.amazon.com).",
