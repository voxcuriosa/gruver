document.addEventListener('DOMContentLoaded', async () => {
  ...
  const TRANSLATIONS = {
    no: {
      ...
      faq5A: "Trykk på «Fane» (<kbd>Option+Shift+C</kbd>) for lynraskt utklipp av nettsiden, eller «Hele PC-en» (<kbd>Option+Shift+X</kbd>) for å klippe ut fra Word, Excel, Teams, PDF-lesere eller skrivebordet. Du kan annotere med Penn/Tusj, sladde sensitive opplysninger med Sladd (Boks/Børste), og kopiere direkte til utklippstavlen med Cmd+V / Ctrl+V!",
